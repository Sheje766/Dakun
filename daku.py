...
TOKEN = '7620212013:AAHnnbHGoVXF6Zyia0TxwsbotaXNLyjg4Ek'
MONGO_URI = 'mongodb+srv://Kamisama:Kamisama@kamisama.m6kon.mongodb.net/'
FORWARD_CHANNEL_ID = -1002270145423
CHANNEL_ID = -1002270145423
error_channel_id = -1002270145423
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./lg {target_ip} {target_port} {duration} 20 ")
